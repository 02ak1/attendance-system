...
def main(name_input,excel_path):
    # JSONファイルの読み込み
    ...
    # 勤務条件のチェック
    errors += check_work_constraints_isct(timetables_work, budget_info_df, work_info_df)
    # 社員情報のチェック
...
if __name__ == "__main__":
    name_input = "尾崎優太"
    excel_path = "/Users/ozakiyuuta/Documents/東工大/T-qard/apps/workreport.xlsx"
    errors = main(name_input, excel_path)
